<template>
    <div
        :id="`post-${post.id}`"
        class="relative bg-white overflow-hidden shadow-xs sm:rounded-lg p-6 text-gray-900 flex items-start space-x-3 border-2 border-transparent"
        :class="{
    ...
    >
        ...
        <div class="w-full">
            <div>
                ...
                <div class="text-sm text-gray-500">
                    Posted
                    <time
                        :datetime="post.created_at.human"
        ...
        <div
            class="absolute right-0 top-0 bg-gray-800 text-gray-100 px-3 py-1 text-xs uppercase tracking-wide font-semibold rounded-bl shadow-sm"
            v-if="isSolution"
        >
            Best answer
        </div>
